...
### 🎪 Демо
![TailSense Demo](docs/image/Снимок%20экрана%202026-03-10%20в%2000.16.29.png)
...
```bash
git clone https://github.com/yourusername/ProjectTailSense.git
cd ProjectTailSense
```
...
- **Email**: chernobai.ak@phystech.edu
